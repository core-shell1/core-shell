...
"${LIANCP_ROOT}/lian_company/venv/Scripts/python.exe" "${LIANCP_ROOT}/lian_company/verify_gemini.py" "$(pwd)"
```
...
리안이 "계속해" 또는 아무 긍정 응답 → Wave 5 자동 시작.
리안이 "잠깐" / "수정" → 지시 받아서 처리 후 Wave 5.
